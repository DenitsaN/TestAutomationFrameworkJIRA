...
public class UserActions {
    ...
    public static void loadBrowser(String baseUrlKey) {
        ...
        dr.get(getConfigPropertyByKey(baseUrlKey));
    }
    ...
    public void moveAndScrollToElement(String locatorKey, Object... arguments) {
//        Actions actionInteractions = new Actions(driver);
//        String xpath = getLocatorValueByKey(locatorKey, arguments);
//        WebElement element = driver.findElement(By.xpath(xpath));
//        actionInteractions.moveToElement(element).perform();
//        actionInteractions.scrollToElement(element).perform();

        JavascriptExecutor js = (JavascriptExecutor) driver;
        String xpath = getLocatorValueByKey("jira.issue.details.container");
        WebElement element = driver.findElement(By.xpath(xpath));
